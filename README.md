...
**Backlog Pixel** es un organizador de ocio (videojuegos, libros, cine) minimalista y elegante, diseñado bajo la filosofía **Local-first** y con una estética **pixel-art** de alta fidelidad. 

Esta aplicación nace de la necesidad de tener un control total sobre nuestro tiempo de ocio, con una herramienta que sea rápida, privada y que funcione perfectamente sin conexión, ya sea en la ciudad o en medio de una ruta de trail running por las montañas de Galicia.
...
1. **Clona el repositorio**:
   ```bash
   git clone [https://github.com/tu-usuario/backlog-pixel.git](https://github.com/tu-usuario/backlog-pixel.git)
